...
public static class BuildScript
{
    public static void BuildIos()
    {
        ...
        const string appIconPath = "Assets/Brand/ChromaPour-AppIcon.png";
        Directory.CreateDirectory(outputPath);

        PlayerSettings.companyName = "Playable Games";
        PlayerSettings.productName = "Chroma Pour";
        PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.iOS, "com.play.watersortpuzzle");
